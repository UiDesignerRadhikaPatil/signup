                    ...
                    <div className='col-12' style={{ display: 'flex', justifyContent: 'center', alignItems: 'center', flexWrap: 'wrap', maxWidth: '600px', }}>
                        ...
                        <div className='col-12' style={{ display: 'flex', flexDirection: 'column', alignItems: 'center' }}>
                            ...
                            <div style={{ display: 'flex', flexDirection: 'row', width: '70%', marginLeft: '0.5%', marginTop:'1%' }}>
                                ...
                                <label htmlFor="terms" style={{ color: '#696969', fontSize: '14px', marginTop: "1%" }}>
                                    I agree to PMS's <a href='#' style={{ color: 'rgb(58, 145, 245)' }}>Terms of Services</a> and <a href='#' style={{ color: 'rgb(58, 145, 245)' }}>Privacy Policy</a>.
                                </label>
                            </div>


                            <div className='account-btn col-12' style={{ display: 'flex', justifyContent: 'center',  }}>
                                <Buttoncomponent  />
                            </div>

                            <div className="col-6" style={{ alignItems: 'center', display: 'flex', textAlign:'center' }}>
